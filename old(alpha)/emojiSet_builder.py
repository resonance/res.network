...
emoji_mapping = {
  "('height_neck_back', 0)":     "😀",
  "('height_neck_back', 90)":    "😁",
  "('height_neck_back', 180)":   "😂",
  "('height_neck_back', 270)":   "😃",
  "('height_scapula', 0)":       "👄",
  "('height_scapula', 90)":      "🏉",
  "('height_scapula', 180)":     "😂",
  "('height_scapula', 270)":     "😇",
  ...
  "('height_armpit', 270)":      "😎",
  "('height_waist_side', 0)":    "🐥",
  "('height_waist_side', 90)":   "🙈",
  "('height_waist_side', 180)":  "🙊",
  "('height_waist_side', 270)":  "😾",
  "('height_hip', 0)":           "🐉",
  "('height_hip', 90)":          "👨",
  "('height_hip', 180)":         "😤",
  "('height_hip', 270)":         "😹",
  "('height_gluteal_fold', 0)":  "😈",
  "('height_gluteal_fold', 90)": "🎃",
  "('height_gluteal_fold', 180)":"🐇",
  "('height_gluteal_fold', 270)":"🍄",
  "('height_knee', 0)":          "👅",
  "('height_knee', 90)":         "🖖",
  "('height_knee', 180)":        "🔥",
  "('height_knee', 270)":        "🌻",
  ...
  "('height_calf', 270)":        "🌊",
  "('height_ankle_high', 0)":    "👖",
  "('height_ankle_high', 90)":   "⭐",
  "('height_ankle_high', 180)":  "🍒",
  "('height_ankle_high', 270)":  "🍅",
  "('height_ankle', 0)":         "👹",
  "('height_ankle', 90)":        "🌈",
  "('height_ankle', 180)":       "🍩",
  "('height_ankle', 270)":       "🎪",
...
extraction_mapping = {
  "760": "height_neck_back",
  "765": "height_neck_back",
  "670": "height_scapula",
  "650": "height_armpit",
  "540": "height_waist_side",
  "545": "height_waist_side",
  "445": "height_hip",
  "410": "height_gluteal_fold",
  "415": "height_gluteal_fold",
  "250": "height_knee",
  "255": "height_knee",
  "170": "height_calf",
  "175": "height_calf",
  "45": "height_ankle",
  "50": "height_ankle",
  "65": "height_ankle_high",
  "70": "height_ankle_high",
  "75": "height_ankle_high"
}

########## EXTERNAL FILES ####################

line2Emoji = "/Users/theodoreseem/Desktop/Emoji_Experiment/Length-Emoji.json"
...
def outputImage(height,width,count,lineObjs):
    ...
    writtenName = '/Users/theodoreseem/Desktop/Emoji_Experiment/ExtractedPatterns_test2/test'+str(count)+'.jpg'
    print(writtenName); time.sleep(.5)
    cv2.imwrite(writtenName,line_image)

def create_emoji(height, width, count, lines):
    emoji_image = np.ones((height, width,3))*255
    emojiPNG = '/Users/theodoreseem/Desktop/Emoji_Experiment/Emoji_Images2/test'+str(count)+'.png'
    distMeasures = [(extraction_mapping[str(line.distance)],int(abs(line.degrees))) for line in lines if str(line.distance) in extraction_mapping]
    emojis = [emoji_mapping[str(distMeasure)]for distMeasure in distMeasures]
    ...
    font = ImageFont.truetype(font_file, 100, encoding='unic')
...
def extractDAG(lines):
    realLines = [line for line in lines if str(line.distance) in extraction_mapping]
...
def cycle_patterns(folder):
    ...
    for count, file in enumerate(files):
        if count < len(files):
            print(file[-10:])
            height,width,lines = extract_lines(file)
            processed_lines = processLines(lines)
            #outputImage(height,width,count+3,processed_lines)
            create_emoji(height, width, count+3, processed_lines)
...
if __name__ == "__main__":
    ...
    patterns_folder = '/Users/theodoreseem/Desktop/Emoji_Experiment/10-fold_images_cropped/'
    cycle_patterns(patterns_folder)
