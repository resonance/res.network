...
def extract_features(image):
    ...
    #img = img[12:pre_height-4, 4: pre_width-4]
    ...
    img, shapes, _ = cv2.findContours(thresh, cv2.RETR_TREE, cv2.CHAIN_APPROX_NONE)

    #loop over the contours
    for c in shapes[10:]:
        print(c)
        cv2.drawContours(line_image, [c], -1, (0,255,0), 1)
    cv2.imwrite('/Users/theodoreseem/Desktop/test.png',line_image)
...
if __name__ == "__main__":
    ...
    #testImage_name = '/Users/theodoreseem/Desktop/Input_Data/DXF_Files/DXFtoPNG/dup.png'

    testImage_name = '/Users/theodoreseem/Desktop/slv-pic.png'
    lines = extract_features(testImage_name)
